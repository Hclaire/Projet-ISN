...
pygame.init() #Ouverture de la fen̻tre Pygame
...
def evenement(numero_fleches_J1, numero_fleches_J2, fenetre):
    ...
    while continuer:
        ...
        for event in pygame.event.get():    #Attente des ̩v̩nements
            ...
            if event.type == QUIT:
                ...
                if event.key == K_d: #Si "fl̬che bas"
                ...
                elif event.key == K_DOWN: #Si "fl̬che bas"
